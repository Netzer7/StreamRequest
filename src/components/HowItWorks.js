...
const StepCard = ({ number, title, description, icon: Icon, isActive }) => {
  return (
    <div 
      ...
      style={{
        backgroundColor: isActive ? 'rgba(0, 160, 160, 0.15)' : 'rgba(74, 74, 74, 0.2)',
        borderRadius: '20px',
    ...
    >
      ...
      <div style={{ marginLeft: '8px' }}>
        ...
        {/* Content */}
        <h3 
          style={{ color: isActive ? 'var(--color-primary)' : 'rgba(0, 160, 160, 0.8)' }}
...
const HowItWorks = () => {
  ...
  const steps = [
    {
      number: "1",
      title: "Sign Up",
      description: "Create your account in less than 2 minutes and start managing your media library effortlessly."
    },
    {
      number: "2",
      title: "Invite Users",
      description: "Add friends and family to your media circle with our simple SMS-based invitation system."
    },
    {
      number: "3",
  ...
  return (
    <section className="relative py-40" style={{ borderTop: '1px solid rgba(74, 74, 74, 0.2)' }}>
      <div style={{ maxWidth: '1200px' }} className="container mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-32">
          <h2 className="text-5xl font-bold mb-8" style={{ color: 'var(--color-primary)' }}>
