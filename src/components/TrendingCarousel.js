...
const TrendingCarousel = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-secondary/10 to-transparent overflow-hidden">
      ...
      >
        <h2 className="container text-4xl font-bold text-center mb-4 text-primary">
          Trending Now
        </h2>
        <p
          className="container text-xl text-center mb-12 text-gray-300"
          style={{ padding: "0 0 24px 20px" }}
        >
